...
export default function RightPanel({ open=true, onClose=()=>{}, anchors=[], employees=[], logs=[], debugInfo=null, frameCount=0, showDebug=false, setShowDebug=()=>{}, invertY=false, setInvertY=()=>{}, calMode=false, setCalMode=()=>{}, onMockAnchors=()=>{}, anchorMode=false, setAnchorMode=()=>{}, showMiniMap=false, setShowMiniMap=()=>{} }){
  return (
    <Mantine.Drawer 
      opened={open}
      onClose={onClose}
        ...
        <Mantine.Tabs defaultValue="devices" keepMounted={false}>
          ...
          <Mantine.Tabs.Panel value="anchors" pt="xs" style={{display:'flex'}}>
            <Mantine.ScrollArea style={{ flex:1 }}>
              ...
              <Mantine.Table highlightOnHover verticalSpacing="xs" fontSize="sm">
                <thead><tr><th>Name</th><th>ID</th><th>nx</th><th>ny</th></tr></thead>
                <tbody>
                  {anchors.map(a=> (
          ...
          <Mantine.Tabs.Panel value="controls" pt="xs">
            <Mantine.Group direction="column" spacing="xs">
              ...
              <label style={{display:'flex', alignItems:'center', gap:8}}>
                ...
                <Mantine.Text size="sm">Flip Y</Mantine.Text>
              </label>
              <label style={{display:'flex', alignItems:'center', gap:8}}>
                <input type="checkbox" checked={calMode} onChange={e=> setCalMode(e.target.checked)} />
                <Mantine.Text size="sm">Calibrate (3‑point)</Mantine.Text>
              </label>
              <label style={{display:'flex', alignItems:'center', gap:8}}>
